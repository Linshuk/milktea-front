 ...
 * 版权所有，侵权必究！
 */
package com.hongkl.shop.security.common.filter;

import cn.dev33.satoken.stp.StpUtil;
import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;
import com.hongkl.shop.exception.YamiShopBindException;
import com.hongkl.shop.handler.HttpHandler;
import com.hongkl.shop.response.ResponseEnum;
import com.hongkl.shop.response.ServerResponseEntity;
import com.hongkl.shop.security.common.adapter.AuthConfigAdapter;
import com.hongkl.shop.security.common.bo.UserInfoInTokenBO;
import com.hongkl.shop.security.common.manager.TokenStore;
import com.hongkl.shop.security.common.util.AuthUserContext;
...
public class AuthFilter implements Filter {
    ...
    public AuthFilter(AuthConfigAdapter authConfigAdapter, HttpHandler httpHandler, TokenStore tokenStore) {
